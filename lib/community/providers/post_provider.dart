...
class PostProvider with ChangeNotifier {
  ...
  // Fetch all posts - fixed column names
  Future<void> fetchPosts() async {
    try {
      ...
      // Query posts that haven't expired yet - using snake_case column names
  ...
  // Fetch posts with search - fixed column names
  ...
  // Add a new post - FIXED VERSION with correct column names
  Future<Post?> addPost(Post post) async {
    try {
      ...
      // Prepare post data with snake_case naming - fixed creator_id
      final postData = {
        'title': post.title,
        ...
        'creator_id': currentUser.id, // Fixed from creatorId to creator_id
  ...
  // Update a post - fixed column names
  Future<bool> updatePost(Post post) async {
    try {
      ...
      final existingPost = await _supabase
          .from('posts')
          .select('creator_id') // Fixed from creatorId
  ...
  // Delete a post - fixed column names
  ...
  // Extend post expiration date - fixed column names
