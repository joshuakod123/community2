...
import 'screens/payment_page.dart';  // Import the payment page
import 'services/premium_service.dart'; // Import premium service
...
void main() async {
  ...
  try {
    ...
    // Create tables in the Supabase database - this now happens manually in the dashboard
    // No need to call DB setup as it requires RPC functions that don't exist
      ...
      child: Consumer<LanguageProvider>(
        builder: (context, languageProvider, child) {
          return MaterialApp(
            ...
            routes: {
              // Removed '/': (context) => const SplashScreen(), - CAUSES CONFLICT
