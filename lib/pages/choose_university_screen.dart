...
class _ChooseUniversityScreenState extends State<ChooseUniversityScreen> {
  ...
  final Map<String, Map<String, List<String>>> universitiesMajors = {
    ...
    '이화여자대학교': {
      '3특' : [
        '국어국문학과', '중어중문학과', '불어불문학과', '독어독문학과', '사학과', '철학과', '기독교학과', '영어영문학과', '정치외교학과', '행정학과',
        '경제학과', '문헌정보학과', '사회학과', '사회복지학과', '심리학과', '소비자학과', '커뮤니케이션-미디어학과', '경영학과', '융합콘텐츠학과',
        '의류산업학과', '국제사무학과', '식품영양학과', '융합보건학과', '수학과', '통계학과', '물리학과', '화학-나노과학과', '생명과학과', '전기전자공학과',
        '지능형반도체공학과', '식품생명공학과', '화공신소재공학과', '건축학과', '건축도시시스템공학과', '환경공학과', '기후에너지시스템공학과', '휴먼기계바이오공학과',
        '간호학과', '컴퓨터공학과', '사이버보안학과', '인공지능데이터사이언스학과', '국제학과', '교육학과', '유아교육과', '초등교육과', '교육공학과', '특수교육과',
        '영어교육과', '역사교육학과', '사회교육학과', '지리교육학과', '국어교육과', '과학교육과', '수학교육과'
      ],
      '12특': [
        '국어국문학과', '중어중문학과', '불어불문학과', '독어독문학과', '사학과', '철학과', '기독교학과', '영어영문학과', '정치외교학과', '행정학과',
        '경제학과', '문헌정보학과', '사회학과', '사회복지학과', '심리학과', '소비자학과', '커뮤니케이션-미디어학과', '경영학과', '융합콘텐츠학과',
        '의류산업학과', '국제사무학과', '식품영양학과', '융합보건학과', '수학과', '통계학과', '물리학과', '화학-나노과학과', '생명과학과', '전기전자공학과',
        '지능형반도체공학과', '식품생명공학과', '화공신소재공학과', '건축학과', '건축도시시스템공학과', '환경공학과', '기후에너지시스템공학과', '휴먼기계바이오공학과',
        '간호학과', '컴퓨터공학과', '사이버보안학과', '인공지능데이터사이언스학과', '국제학과'
      ]
    },

    '가톨릭대학교': {
      '3특' : [
        '국어국문학과', '철학과', '국사학과', '영어영문학과', '중국언어문화학과', '일어일본문화학과', '프랑스어문화학과', '사회복지학과', '심리학과',
        '사회학과', '경영학과', '회계학과', '국제학과', '법학과', '경제학과', '행정학과', '아동학과', '화학과', '수학과', '물리학과', '공간디자인-소비자학과',
        '의류학과', '식품영양학과', '컴퓨터정보공학과', '미디어기술콘텐츠학과', '정보통신전자공학과', '생명공학과', '에너지환경공학과', '바이오메디컬화학공학과',
        '의생명과학과', '인공지능학과', '데이터사이언스학과', '바이오메디컬소프트웨어학과', '특수교육과', '자유전공학과', '의예과', '간호학과'
      ],
      '12특': [
        '국어국문학과', '철학과', '국사학과', '영어영문학과', '중국언어문화학과', '일어일본문화학과', '프랑스어문화학과', '사회복지학과', '심리학과',
        '사회학과', '경영학과', '회계학과', '국제학과', '법학과', '경제학과', '행정학과', '아동학과', '화학과', '수학과', '물리학과', '공간디자인-소비자학과',
