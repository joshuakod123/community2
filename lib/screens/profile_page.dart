...
import '../screens/premium_page.dart'; // Updated import to match your file structure
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  final PremiumService _premiumService = PremiumService(); // Add premium service
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            _buildSettingsOption(
                              ...
                              title: userData['isPremium'] ? "Manage Premium" : "Premium Payment",
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => const PremiumPage()),
                                ).then((_) {
                                  // Refresh premium status when returning from payment page
                                  _checkPremiumStatus();
                                });
                              },
                            ),
