...
class _NotificationSettingsPageState extends State<NotificationSettingsPage> {
  ...
  Future<void> _loadNotificationPreferences() async {
    ...
    final communityEnabled = await _notificationService.getNotificationPreference('community');
      ...
      body: _isLoading
        ...
        child: Column(
          ...
          children: [
            ...
            _buildNotificationToggle(
              title: "Community",  // You can replace with AppLocalizations when available
