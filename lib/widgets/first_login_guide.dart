...
class FirstLoginGuide {
  ...
  /// Show the first login guide as a modal bottom sheet if needed
  static Future<void> showIfNeeded(BuildContext context) async {
    try {
      ...
      final String userKey = user != null ? '${_prefsKey}_user_${user.id}' : _prefsKey;
      ...
      print('Error showing first login guide: $e');
    }
  }
}
